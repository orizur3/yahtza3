...
export default function LogPage() {
  ...
  const roleFilteredEntries = (isHQ && viewAllCompanies) ? entries : isHQ ? entries.filter(e => e.reported_by_role === 'אגם' || !e.reported_by_role || e.entry_type === 'auto') : entries.filter(e => {
    if (e.reported_by_role === userRole) return true
    if (!e.related_report_id) return e.entry_type === 'auto'
